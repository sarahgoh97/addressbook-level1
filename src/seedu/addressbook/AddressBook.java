...
public class AddressBook {
    ...
    */
    /** Using a HashMap<PersonProperty, String to store the different data elements of a person
     * instead of String[] storage format.
     */
    ...
    changed to PersonProperty - LO-Enums
    */
    ...
    */
    ...
    private static ArrayList<HashMap<PersonProperty, String>> loadPersonsFromFile(String filePath) {
        ...
        final Optional<ArrayList<HashMap<PersonProperty, String>>> successfullyDecoded = decodePersonsFromStrings(linesInFile);
